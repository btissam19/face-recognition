...
const enableWebcam = () => {
    ...
    navigator.mediaDevices.getUserMedia(constraints)
      .then((stream) => {
        ...
        setEnableWebcamButton(true); // Update state here
...
useEffect(() => {
  ...
  return (
    <section id="demos" className="invisible">
      ...
      <p>
        Hold your face in front of your webcam to get real-time face landmarker detection.</p>
        <br />
      ...
      <div style={{ position: 'relative' }}>
        <video id="webcam" style={{ position: 'absolute' }} ref={webcamRef} autoPlay playsInline></video>
